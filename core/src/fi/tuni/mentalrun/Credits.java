 ...
 * @author Joni Mäkinen
 */
public class Credits extends fi.tuni.mentalrun.GameProject implements Screen {
    fi.tuni.mentalrun.MenuBackground menuBackground = new MenuBackground();
    fi.tuni.mentalrun.Button button = new Button();

    fi.tuni.mentalrun.SpecialCollectible specialCollectible = new SpecialCollectible();
