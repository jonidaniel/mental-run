...
public class HighScoreServer extends GameProject {
     ...
     */
    public static void fetchHighScores(final fi.tuni.mentalrun.HighScoreListener source, int levelVariable) {
        ...
        try {
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                ArrayList<fi.tuni.mentalrun.HighScoreEntry> highScores = new ArrayList<>();

                for (int i = 1; i <= 10; i++) {
                    JsonValue entry = jsonObject.get(String.valueOf(i));
                    if (entry != null) {
                        fi.tuni.mentalrun.HighScoreEntry score = new fi.tuni.mentalrun.HighScoreEntry(
