 ...
 * @author Joni Mäkinen
 */
public class HighScores extends fi.tuni.mentalrun.GameProject implements HighScoreListener, Screen {
     ...
     */
    public HighScores(fi.tuni.mentalrun.GameProject host, boolean musicOn, boolean soundOn, Music menuBackgroundMusic, Music runBackgroundMusic, int levelVariable, float statetime) {
        this.host = host;
    ...
    @Override
    public void receiveHighScore(List<fi.tuni.mentalrun.HighScoreEntry> highScores) {
     ...
     */
    private void updateScores(List<fi.tuni.mentalrun.HighScoreEntry> scores) {
        for (fi.tuni.mentalrun.HighScoreEntry e : scores) {
    ...
    public void createNewScore(int levelVariable, String name, String scoreString) {
        ...
        fi.tuni.mentalrun.HighScoreEntry scoreEntry = new HighScoreEntry(name, score);
