 ...
 * @author Joni Mäkinen
 */
public class Level1Tutorial extends fi.tuni.mentalrun.GameProject implements Screen {
    MenuBackground menuBackground = new MenuBackground();
    Button button = new Button();

    AlarmClock alarmClock = new AlarmClock();
    Backpack backpack = new Backpack();
    fi.tuni.mentalrun.Bed bed = new Bed();
    NoBreakfast noBreakfast = new NoBreakfast();
    fi.tuni.mentalrun.Porridge porridge = new Porridge();
    fi.tuni.mentalrun.Toothbrush toothbrush = new Toothbrush();
