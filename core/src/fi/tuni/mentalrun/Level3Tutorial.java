 ...
 * @author Joni Mäkinen
 */
public class Level3Tutorial extends fi.tuni.mentalrun.GameProject implements Screen {
    fi.tuni.mentalrun.MenuBackground menuBackground = new MenuBackground();
    fi.tuni.mentalrun.Button button = new Button();

    fi.tuni.mentalrun.EnergyDrink energyDrink = new EnergyDrink();
    fi.tuni.mentalrun.Gaming gaming = new Gaming();
    fi.tuni.mentalrun.Sandwich sandwich = new Sandwich();
    fi.tuni.mentalrun.Shower shower = new Shower();
    fi.tuni.mentalrun.Sleep sleep = new Sleep();
    fi.tuni.mentalrun.Toothbrush3 toothbrush3 = new Toothbrush3();
