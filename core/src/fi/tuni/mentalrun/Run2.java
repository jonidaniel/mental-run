 ...
 * @author Joni Mäkinen
 */
public class Run2 extends fi.tuni.mentalrun.GameProject implements Screen {
    Player player = new Player();
    fi.tuni.mentalrun.Button button = new Button();
    Lives lives = new Lives();
    fi.tuni.mentalrun.Points points = new Points();
    fi.tuni.mentalrun.Countdown countdown = new Countdown();
    fi.tuni.mentalrun.GameOver gameOver = new GameOver();
    ...
    fi.tuni.mentalrun.SpecialCollectible specialCollectible = new SpecialCollectible(collectibleYPos);
    fi.tuni.mentalrun.Sociability sociability = new Sociability(collectibleYPos);
    fi.tuni.mentalrun.Schoolbook schoolbook = new Schoolbook(collectibleYPos);
    fi.tuni.mentalrun.Football football = new Football(collectibleYPos);
    Lunch lunch = new Lunch(collectibleYPos);
    Candy candy = new Candy(collectibleYPos);
    fi.tuni.mentalrun.MobilePhone mobilePhone = new MobilePhone(collectibleYPos);
